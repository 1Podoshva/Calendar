...
- (void)viewDidLoad {
    ...
    [calendar setFrame:CGRectMake(0, self.view.frame.size.height / 2, self.view.frame.size.width, self.view.frame.size.height / 2)];
    ...
    calendar.selectQuickDaysColor = [UIColor colorWithRed:170.0 / 255.0 green:188.0 / 255.0 blue:98.0 / 255.0 alpha:1];
